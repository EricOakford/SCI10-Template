...
(class Inventory of IconBar
	...
	(method (doit &tmp theCurIcon newEvent newEventType [temp3 3] systemWindowEraseOnly temp7 temp8)
			...
			(cond 
				...
				(
					...
					(if (== (newEvent message?) verbHelp)
						...
						(cond 
							((not (theCurIcon isKindOf: InvItem))
